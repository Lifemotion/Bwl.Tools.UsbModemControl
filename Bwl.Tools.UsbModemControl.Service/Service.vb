...
Module Service
    ...
    Dim WithEvents _modem As New ModemControl(_app.RootLogger, _app.AutoUI)
    ...
    Sub Main()
        _app.RootLogger.ConnectWriter(New ConsoleLogWriter) 'With {.WriteExtended = True})
        _app.RootLogger.AddMessage("Modem Control App started")
        _modem.RunInConsoleThread()
        Do While _running
    ...
    Private Sub OnNeedExitApp() Handles _exitButton.Click, _modem.NeedExitApp
        _running = False
    End Sub
End Module
